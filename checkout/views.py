...
def cache_checkout_data(request):
    try:
        ...
        stripe.PaymentIntent.modify(pid, metadata={
            'shoppingcart': json.dumps(request.session.get('shoppingcart',
                                                           {})),
...
def checkout(request):
    ...
    if request.method == 'POST':
            ...
            for item_id, item_data in shoppingcart.items():
                try:
                    ...
                    messages.error(request, (
                        "One of the products in your shoppingcart"
        ...
        # Attempt to prefill the form with any info from the user profile
